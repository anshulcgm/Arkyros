...
namespace Pathfinding
{
    ...
    public class PathfindMaster : MonoBehaviour
    {
        ...
        public delegate void PathfindingJobComplete(List<GridNode> path);
        ...
        public void RequestPathfind(GridNode start, GridNode target, PathfindingJobComplete completeCallback)
        {
