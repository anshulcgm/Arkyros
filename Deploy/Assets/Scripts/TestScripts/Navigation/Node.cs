...
{ 
    ...
    public bool isPassableForMeteor = false;

    public int islandNum = 0;

    public DateTime lastCostTime = DateTime.MinValue;
    
    public void setLastCostTime()
    {
        lastCostTime = DateTime.Now;
    }
    ...
    public void smoothConnections()
    {
        ...
        foreach (Node n in connectedNodes)
        {
            ...
            {
                //connect n to us.
                connectedNodes[i].connectedNodes[(i + 4) % 8] = null;
            }
            i++;
        }
    }
    ...
    public void setConnectedNodes(Node[] adjacentNodes, LayerMask collisionLayer)
    {
        ...
        isPassableForMeteor = !Physics.CheckBox(location, new Vector3(0.5f, 0.5f, 0.5f), Quaternion.identity, collisionLayer);
    }
